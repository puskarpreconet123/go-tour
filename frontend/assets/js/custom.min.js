! function (a) {
    document.addEventListener("DOMContentLoaded", function () {
        window.addEventListener("scroll", function () {
            var b = document.querySelector(".site-header").offsetHeight;
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', 'body.menu-overlay', function (e) {

                if (!$(e.target).closest('.slicknav_nav, .slicknav_btn').length) {
        ...
        $(document).click(function (e) {
            ...
            const menu = $('.slicknav_nav');
            const button = $('.slicknav_btn');

            // If menu is open
            if (button.hasClass('slicknav_open')) {

                // Clicked outside menu + outside button
                if (
                !$(e.target).closest('.slicknav_nav').length &&
                !$(e.target).closest('.slicknav_btn').length
                ) {
